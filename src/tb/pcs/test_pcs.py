...
class PCS_TB:
    ...
    async def loopback(self, delay=1):
        # while True:
        #     await First(*[Edge(self.dut.xver_tx_data), 
        #                            Edge(self.dut.xver_tx_header), 
        #                            Edge(self.dut.xver_tx_gearbox_sequence)])
